...
@Component
public class CreateUserResponseEncoder implements Encoder<CreateUserResponse> {

    @Override
    public DataBuffer encodeValue(CreateUserResponse value, DataBufferFactory bufferFactory, ResolvableType valueType, MimeType mimeType, Map<String, Object> hints) {
    ...
    @Override
    public Flux<DataBuffer> encode(Publisher<? extends CreateUserResponse> inputStream, DataBufferFactory bufferFactory, ResolvableType elementType, MimeType mimeType, Map<String, Object> hints) {
