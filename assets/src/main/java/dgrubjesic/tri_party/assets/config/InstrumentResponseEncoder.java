...
@Component
public class InstrumentResponseEncoder implements Encoder<InstrumentAssetResponse> {

    @Override
    public DataBuffer encodeValue(InstrumentAssetResponse value, DataBufferFactory bufferFactory, ResolvableType valueType, MimeType mimeType, Map<String, Object> hints) {
    ...
    @Override
    public Flux<DataBuffer> encode(Publisher<? extends InstrumentAssetResponse> inputStream, DataBufferFactory bufferFactory, ResolvableType elementType, MimeType mimeType, Map<String, Object> hints) {
